...
import static vfyjxf.bettercrashes.mixinplugin.TargetedMod.VANILLA;
...
public enum Mixin {
    ...
    MinecraftMixin("minecraft.MinecraftMixin", Side.BOTH, VANILLA),
    CrashReportMixin("minecraft.CrashReportMixin", Side.BOTH, VANILLA);
